...
update_dict = {
    ...
    "192.0.2.1": "ns1.example.org",
    "198.51.100.1": "ns2.example.org",
...
def test_update_dns_table_with_dict() -> None:
    """
    Test the function `update_dns_table_with_dict`,
    which updates a DNS table with entries from a dictionary.
    """
    dns_table = {}
    dns_table = dns_reader.update_dns_table_with_dict(dns_table, update_dict)
